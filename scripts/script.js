...
function totais (){
  ...
  treceitas.innerText = totalReceita.replace('.',',');
  tdespesa.innerText = totalDespesa.replace('.',',');
  tvalor.innerText = total.replace('.',',')
}
// Deleta o item no localStorage
function deleta(index){
  const con = confirm("Deseja excluir essa conta!!")
